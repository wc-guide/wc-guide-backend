...
from guide.wc.utils import get_features, get_properties, is_type_iv, has_urinal, supports_female, supports_male, \
...
def data():
    ...
    file_path = os.path.join(dir_path, '../data/osm_test.geojson')
